function processEstatesAgencyCommands(commands) {
    ...
    var Estate = (function () {
        ...
        function Estate(name, area, location, isFurnitured) {
            ...
            this._setFurniture(isFurnitured);
        }
        ...
        // Get Furniture
        Estate.prototype.hasFurniture = function () {
            return this._isFurnitured;
        };

        // Set Furniture
        Estate.prototype._setFurniture = function (isFurnitured) {
        ...
        Estate.prototype.toString = function () {
            var isFurnituredString = this.hasFurniture() ? "Yes" : "No";

            return "Name = " + this.getName() + ", Area = " + this.getArea() + ", Location = " + this.getLocation() + ", Furnitured = " + isFurnituredString;
        };
    ...
    var BuildingEstate = (function () {
        ...
        BuildingEstate.prototype.setNumberOfRooms = function (numberOfRooms) {
            this.validateIntegerRange(numberOfRooms, "numberOfRooms", 0, 100);
        ...
        BuildingEstate.prototype.toString = function () {
            var baseString = Estate.prototype.toString.call(this);
            var hasElevatorStirng = this.getHasElevator() ? "Yes" : "No";

            return baseString + ", Rooms: " + this.getNumberOfRooms() + ", Elevator: " + hasElevatorStirng;
        };
    ...
    var Apartment = (function () {
        ...
        function Apartment(name, area, location, isFurnitured, numberOfRooms, hasElevator) {
            BuildingEstate.call(this, name, area, location, isFurnitured, numberOfRooms, hasElevator);
        }

        Apartment.inherits(BuildingEstate);

        Apartment.prototype.toString = function () {
            return "Apartment: " + BuildingEstate.prototype.toString.call(this);
        };
    ...
    var Office = (function () {
        ...
        Office.prototype.toString = function () {
            return "Office: " + BuildingEstate.prototype.toString.call(this);
        };
    ...
    var House = (function () {
        ...
        House.prototype.toString = function () {
            ...
            return "House: " + baseString + ", Floors: " + this.getFloors();
        };
    ...
    var Garage = (function () {
        ...
        Garage.prototype.toString = function () {
            ...
            return "Garage: " + baseString + ", Width: " + this.getWidth() + ", Height: " + this.getHeight();
        };
    ...
    var Offer = (function () {
        ...
        Offer.prototype.setPrice = function (price) {
            this.validateIntegerRange(price, "price", 1, Number.MAX_VALUE);
    ...
    var RentOffer = (function () {
        ...
        RentOffer.prototype.toString = function () {
            var baseString = Offer.prototype.toString.call(this);

            return "Rent: " + baseString;
        };
        return RentOffer;
    }());
    ...
    var EstatesEngine = (function () {
        ...
        function executeFindSalesByLocationCommand(location) {
            return executeFindOfferTypeByLocationCommand(location, SaleOffer);
        }

        function executeFindRentsByLocationCommand(location) {
            return executeFindOfferTypeByLocationCommand(location, RentOffer);
        }

        function executeFindOfferTypeByLocationCommand(location, offerType) {
            if (!location) {
        ...
        function executeFindRentsByPriceCommand(minPrice, maxPrice) {
            ...
            Object.validateIntegerRange(maxPrice, "maxPrice", minPrice, Math.MAX_VALUE);
            Object.validateIntegerRange(minPrice, "minPrice", 0, maxPrice);
