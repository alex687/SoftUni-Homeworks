namespace Customer
{
    ...
    public class Customer : ICloneable, IComparable<Customer>
    {
        ...
        public Customer(long id, string firstName, string middleName, string lastName, string mobilePhone, string email, string address, CustomerType type, List<Payment> payments)
        {
            this.Id = id;
