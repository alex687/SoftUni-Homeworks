...
namespace CohesionAndCoupling
{
    class UtilsExamples
    {
        static void Main()
        {
            ...
            Console.WriteLine("Volume = {0:f2}", Utils.CalcVolume(3,4,5));
            Console.WriteLine("Diagonal XYZ = {0:f2}", Utils.CalcDiagonalXYZ(3,4,5));
            Console.WriteLine("Diagonal XY = {0:f2}", Utils.CalcDiagonalXY(3,4));
            Console.WriteLine("Diagonal XZ = {0:f2}", Utils.CalcDiagonalXZ(3,5));
            Console.WriteLine("Diagonal YZ = {0:f2}", Utils.CalcDiagonalYZ(4,5));
        }
    }
}
